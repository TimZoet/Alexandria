...
void CreateTypeReferenceArray::operator()()
{
    ...
    std::vector<utils::Property> properties = {
      {0, "prop1", alex::toString(alex::DataType::Type), type2->getId(), 1, 1, 0},
      {0, "prop3", alex::toString(alex::DataType::Float), 0, 0, 0, 0},
      {0, "prop2", alex::toString(alex::DataType::Type), type3->getId(), 1, 1, 0},
      {0, "prop0", alex::toString(alex::DataType::Type), type1->getId(), 1, 1, 0},
    };
